"""
Django settings for new_app_4_4 project.
...
WSGI_APPLICATION = 'new_app_4_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "new-app-4 Support <support@new-app-4-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_app_4_4 API",
    "DESCRIPTION": "API documentation for new_app_4_4 App",
    "VERSION": "v1",
}
